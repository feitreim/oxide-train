            ...
            profiler.measure(stream, name, || unsafe {
                ...
                unsafe {
                    tcgen05.f32_store(
                        ...
                        staging.row_maps.get::<D, FF>(IN).operand(),
                        compute.transposed_tma.operand(),
                        output.as_device_buffer_mut(),
                        OUT as u32,
                        IN as u32,
                    )
            ...
            && tcgen05_linear_eligible(N, IN, OUT)
        {
            ...
            profiler.measure(stream, names[0], || unsafe {
                ...
                unsafe {
                    tcgen05.f32_accumulate_transposed(
                        ...
                        staging.lhs_mn_maps.get::<D, FF>(IN).operand(),
                        staging.row_mn_maps.get::<D, FF>(OUT).operand(),
            ...
            profiler.measure(stream, names[1], || unsafe {
                tcgen05.f32_store(
                    ...
                    staging.row_maps.get::<D, FF>(OUT).operand(),
                    compute.normal_tma.operand(),
            ...
            && tcgen05_linear_eligible(N, IN, width)
        {
            ...
            profiler.measure(stream, names[0], || unsafe {
                ...
                unsafe {
                    tcgen05.f32_accumulate_transposed(
                        ...
                        staging.lhs_mn_maps.get::<D, FF>(IN).operand(),
                        staging.row_mn_maps.get::<D, FF>(width).operand(),
                        self.dw.as_device_buffer_mut(),
                        width as u32,
                        N as u32,
                    )
            ...
            profiler.measure(stream, names[1], || unsafe {
                tcgen05.f32_store(
                    ...
                    staging.row_maps.get::<D, FF>(width).operand(),
                    compute.normal_tma.operand(),
                    dx.as_device_buffer_mut(),
                    IN as u32,
                    width as u32,
            ...
            for expert in 0..E {
                unsafe {
                    tcgen05.f32_store_at(
                        ...
                        input.k_maps[expert].operand(),
                        compute.transposed_maps[expert].operand(),
                        output,
            ...
            for expert in 0..E {
                unsafe {
                    tcgen05.f32_accumulate_transposed_at(
                        ...
                        input.mn_maps[expert].operand(),
                        dy.mn_maps[expert].operand(),
                        weight_gradient,
            ...
            for expert in 0..E {
                unsafe {
                    tcgen05.f32_store_at(
                        ...
                        dy.k_maps[expert].operand(),
                        compute.normal_maps[expert].operand(),
                        input_gradient,
                        expert * C * input_width,
                        C * input_width,
                        input_width as u32,
